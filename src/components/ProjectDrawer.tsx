...
import { X, Settings, Users, Trash2, Archive, Share2, Bell, Folder } from 'lucide-react';
...
const ProjectDrawer: React.FC<ProjectDrawerProps> = ({ project, isOpen, onClose }) => {
  ...
  const menuItems = [
    { icon: Settings, label: 'General Settings', description: 'Project name, description, and preferences' },
    { icon: Users, label: 'Team Members', description: 'Manage project members and roles' },
    { icon: Share2, label: 'Sharing', description: 'Project visibility and sharing options' },
    { icon: Bell, label: 'Notifications', description: 'Configure project notifications' },
    { icon: Archive, label: 'Archive', description: 'Archive this project', danger: false },
    { icon: Trash2, label: 'Delete', description: 'Permanently delete this project', danger: true },
  ];
